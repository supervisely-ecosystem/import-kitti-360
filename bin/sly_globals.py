...
kitti360_local_dir = os.path.join(my_app.data_dir, 'kitti360data')
...
seq_dir_path_relative = './data_3d_raw'
bins_dir_path_relative = './data_3d_raw/{}/velodyne_points/data/'  # paste seq name
bboxes_path_relative = './data_3d_bboxes/train/'
